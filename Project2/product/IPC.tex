...
\mainmatter
\pagestyle{fancy}
\include{chapter/1-BasicInformation}
\include{chapter/2-LearningGoals}
\include{chapter/3-AssessmentforLearning}
\include{chapter/4-TheEntryPoint}
\include{chapter/5-KnowledgeHarvest}
\include{chapter/6-TheBigIdea}
\include{chapter/7-explainingTheTheme}
\include{chapter/8-TheBigPicture}
\include{chapter/9-BrainwaveUnitLearningGoals}
\include{chapter/10-BrainwaveUnitTask1-AboutLearning}
\include{chapter/11-BrainwaveUnitTask2-Skillsneedpractice}
\include{chapter/12-BrainwaveUnitTask3Insidethebrain}
\include{chapter/13-MultiplePerspective}
\include{chapter/14-BrainwaveUnitTask5-InternationalMindedness}
\include{chapter/15-BrainwaveUnitTask6-PositiveThingk}
\include{chapter/16-BrainwaveUnitTask7-CaringforourBrain}
\include{chapter/17-TheExitPoint}
\include{chapter/18-Resources}
%\input{appendix}
%\end{appendix}
